...
- Currently working on <b>visulizing chemical composision of feminine hygiene products.</b> The project uses public data as raw data, which was officially realsed on December 30 last year by Ministry of Food and Drug Safety(MFDS). Anyone can access this data [on this page](https://www.mfds.go.kr/brd/m_99/view.do?seq=44922) and check the results of feminine hygiene products' quality monitoring.
